export default function Toasts() {
    return (
        <div className="space-y-6 grid justify-center mt-4">
            ...
            <div
                className="bg-yellow-50 border border-gray-300 border-l-[6px] border-l-yellow-600 flex items-start w-full min-w-xs max-w-lg p-4 rounded-md"
                role="alert"
            >
                <div className="mr-3 shrink-0">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="w-5 h-5 fill-yellow-600 inline"
                        viewBox="0 0 128 128"
                    >
                ...
                <div>
                    <h6 className="text-yellow-600 text-[15px] font-semibold tracking-wide">
                        Caution: Please review this
                    </h6>
                    <p className="text-sm text-slate-600 mt-0.5">
                        Something may need your attention before proceeding.
                    </p>
                </div>
                <button
                    type="button"
            ...
            <div
                className="bg-blue-50 border border-gray-300 border-l-[6px] border-l-blue-600 flex items-start w-full min-w-xs max-w-lg p-4 rounded-md"
                role="alert"
            >
                <div className="mr-3 shrink-0">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="w-5 h-5 fill-blue-600 inline"
                ...
                <div>
                    <h6 className="text-blue-600 text-[15px] font-semibold tracking-wide">
                        Here’s a helpful note
                    </h6>
                    <p className="text-sm text-slate-600 mt-0.5">
                        This is just to inform you about something important.
                    </p>
                </div>
                <button
                    type="button"
